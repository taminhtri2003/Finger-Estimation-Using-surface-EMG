function [models, predictions, Y_all] = emg_to_angle_regression(dsfilt_emg, joint_angles)
    % Inputs:
    ...
    % Initialize storage
    X_all = [];  % Features
    Y_all = [];  % Target angles (matrix with 15 columns)
    ...
    num_joints = size(Y_all, 2);  % Should be 15 (5 fingers x 3 joints, with thumb DIP as NaN)
